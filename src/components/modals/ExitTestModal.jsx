...
const ExitTestModal = ({
  ...
  return (
    <div className="bg-opacity-50 fixed inset-0 z-50 flex items-center justify-center bg-black p-4 transition-opacity duration-200 animate-in fade-in">
      <div className="w-full max-w-md animate-in zoom-in-95 rounded-lg bg-white p-6 shadow-2xl transition-all duration-200 dark:bg-gray-800">
