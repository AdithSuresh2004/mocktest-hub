...
import { FaPlus, FaTrash, FaToggleOn, FaToggleOff, FaGlobe, FaServer, FaExclamationTriangle, FaCheckCircle } from 'react-icons/fa'
import {
  getExamSources,
  addExamSource,
  deleteExamSource,
          ...
          <div className="space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100"
              />
            </div>
            <div>
              <label className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
              ...
              <input
                ...
                placeholder="https://example.com/exams or https://example.com/exams_manifest.json"
                className="w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100"
              />
              <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                💡 Supports CORS-enabled servers. Test the connection before adding.
              </p>
            </div>
              ...
              <div>
                ...
                <div className="mt-1 flex items-center gap-2">
                  ...
                  <span className="text-xs text-gray-500 dark:text-gray-400">
                    {source.type === 'local' ? 'Local Storage' : 'Remote Source'}
                  </span>
                </div>
              </div>
            </div>
