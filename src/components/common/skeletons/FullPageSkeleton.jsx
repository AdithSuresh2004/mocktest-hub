  ...
  <div className="min-h-full bg-gray-50 p-4 sm:p-6 lg:p-8 dark:bg-gray-900">
    <div className="mx-auto max-w-7xl">
      <div className="mb-8 flex items-center justify-between">
        <div className={`h-8 w-48 rounded bg-gray-300 dark:bg-gray-700 ${shimmerClass}`}></div>
        <div className={`h-10 w-32 rounded-md bg-gray-300 dark:bg-gray-700 ${shimmerClass}`}></div>
      </div>
      ...
      <div className="mt-10 grid gap-10 xl:grid-cols-2">
        <div className={`rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800 ${shimmerClass}`}>
