export default function ExamNavigation({
  ...
  return (
    <footer className="z-10 border-t border-gray-200 bg-white px-4 py-3 shadow-lg dark:border-gray-700 dark:bg-gray-800">
      <div className="mx-auto flex max-w-4xl items-center justify-between">
        <button
          onClick={onPrev}
          disabled={!canGoPrev}
          className={`rounded-lg px-6 py-2 font-medium shadow-sm transition-all ${
            canGoPrev
