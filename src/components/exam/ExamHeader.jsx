...
import { FaExpandArrowsAlt, FaArrowLeft, FaCompress, FaClock, FaExclamationTriangle } from 'react-icons/fa'
import ThemeToggle from '@/components/common/ThemeToggle'
import { useExamHeaderState } from '@/hooks/exam/useExamHeaderState'
import { formatTime } from '@/utils/helpers/examHelpers'

export default function ExamHeader({ exam, timeRemaining, onExit, isWarning, isCritical }) {
  const { isFullscreen, timeColorClass, toggleFullscreen } =
    useExamHeaderState(timeRemaining)

  // Enhanced timer styling based on warnings
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div
            ...
            aria-live="polite"
            aria-atomic="true"
            title={isCritical ? 'Less than 1 minute remaining!' : isWarning ? 'Less than 5 minutes remaining' : 'Time remaining'}
          >
          ...
          <button
            ...
            className="rounded-md p-2 text-gray-600 transition-colors hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:text-gray-300 dark:hover:bg-gray-700"
          ...
          <button
            onClick={onExit}
            className="rounded-md p-2 text-gray-600 transition-colors hover:bg-red-50 hover:text-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 dark:text-gray-300 dark:hover:bg-red-900/20 dark:hover:text-red-400"
