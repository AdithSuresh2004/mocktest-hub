import { FaClock, FaListAlt, FaCheckCircle, FaExclamationTriangle, FaKeyboard } from 'react-icons/fa'
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-100 p-4 dark:bg-gray-900">
      <div className="w-full max-w-4xl rounded-lg bg-white p-8 shadow-lg dark:bg-gray-800">
        ...
        <div className="mb-8 grid gap-6 md:grid-cols-2">
          ...
          <div className="rounded-lg bg-purple-50 p-4 dark:bg-purple-900/20">
            <div className="mb-2 flex items-center gap-2">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-gray-100">Total Questions</h3>
            </div>
            <p className="text-gray-700 dark:text-gray-300">
          ...
          <div className="rounded-lg bg-green-50 p-4 dark:bg-green-900/20">
            <div className="mb-2 flex items-center gap-2">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-gray-100">Total Marks</h3>
            </div>
            <p className="text-gray-700 dark:text-gray-300">
        ...
        <div className="mb-6 space-y-4">
          <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">General Instructions:</h2>
          
          <div className="space-y-3 text-gray-700 dark:text-gray-300">
            <div className="flex gap-3">
              <span className="font-semibold">1.</span>
              <p>The exam will start as soon as you click the "Start Exam" button below.</p>
            </div>
            <div className="flex gap-3">
            ...
            <div className="flex gap-3">
              ...
              <p>You can navigate between questions using the navigation panel on the right.</p>
            </div>
            <div className="flex gap-3">
            ...
            <div className="flex gap-3">
              ...
              <p>Make sure you have a stable internet connection throughout the exam.</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-6 rounded-lg bg-gray-50 p-4 dark:bg-gray-700">
          ...
          <div className="grid gap-2 text-sm text-gray-700 dark:text-gray-300 md:grid-cols-2">
            <div className="flex justify-between">
              ...
              <kbd className="rounded bg-white px-2 py-1 font-mono shadow dark:bg-gray-600">→</kbd>
            </div>
            <div className="flex justify-between">
            ...
            <div className="flex justify-between">
              ...
              <kbd className="rounded bg-white px-2 py-1 font-mono shadow dark:bg-gray-600">M</kbd>
            </div>
            <div className="flex justify-between">
              <span>Fullscreen:</span>
              <kbd className="rounded bg-white px-2 py-1 font-mono shadow dark:bg-gray-600">F</kbd>
            </div>
          </div>
        </div>
        ...
        <div className="mb-6 rounded-lg bg-yellow-50 p-4 dark:bg-yellow-900/20">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-gray-700 dark:text-gray-300">
              ...
              <p>Once you start the exam, you cannot restart it. Make sure you are ready before clicking "Start Exam".</p>
            </div>
          </div>
        </div>
