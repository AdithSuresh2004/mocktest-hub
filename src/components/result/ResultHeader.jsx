...
const ResultHeader = ({ examName }) => {
  return (
    <div className="relative overflow-hidden rounded-b-2xl bg-gradient-to-br from-blue-500 via-purple-500 to-indigo-600 p-4 pb-8 text-center shadow-xl sm:mb-8 sm:rounded-b-3xl sm:p-6 sm:pb-12 lg:pb-16 dark:from-blue-700 dark:via-purple-600 dark:to-indigo-800">
      ...
      <Link
        to="/"
        className="absolute left-2 top-2 z-20 flex items-center gap-1 rounded-full bg-white/20 p-2 text-xs font-medium text-white backdrop-blur-sm transition-all hover:bg-white/30 focus:outline-none focus:ring-2 focus:ring-white/50 sm:left-4 sm:top-4 sm:gap-2 sm:p-2.5 sm:text-sm"
      >
        <FaHome className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
        <span className="hidden sm:inline">Home</span>
      </Link>
      <div className="relative z-10">
        <div className="mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded-full bg-white/25 ring-4 ring-white/20 shadow-inner backdrop-blur-sm sm:mb-4 sm:h-18 sm:w-18 sm:ring-8">
